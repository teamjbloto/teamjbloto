...
echo -e "\033[0;00m"
echo -e "\e[36m"
./tg -s ./BLOTO.lua -p PROFILE --bot=$token
done
]])  
file:close()  
file = io.open("BK", "w")  
...
while(true) do
rm -fr ../.telegram-cli
screen -S BLOTO -X kill
screen -S BLOTO ./BLOTO
done
]])  
file:close() 
...
io.popen("cd File_Bot && wget https://raw.githubusercontent.com/teamjbloto/Fbloto/main/File_Bot/commands.lua") 
...
sudo_users = {SUDO,963222161,665877797}   
...
if tonumber(user_id) == tonumber(963222161) then  
var = true  
...
local BLOTO_Msg = ''  
if msgs < 100 then 
BLOTO_Msg = 'غير متفاعل' 
elseif msgs < 200 then 
BLOTO_Msg = 'بده يتحسن' 
elseif msgs < 400 then 
BLOTO_Msg = 'شبه متفاعل' 
elseif msgs < 700 then 
BLOTO_Msg = 'متفاعل' 
elseif msgs < 1200 then 
BLOTO_Msg = 'متفاعل قوي' 
elseif msgs < 2000 then 
BLOTO_Msg = 'متفاعل جدا' 
elseif msgs < 3500 then 
BLOTO_Msg = 'اقوى تفاعل'  
elseif msgs < 4000 then 
BLOTO_Msg = 'متفاعل نار' 
elseif msgs < 4500 then 
BLOTO_Msg = 'قمة التفاعل'
elseif msgs < 5500 then 
BLOTO_Msg = 'اقوى متفاعل' 
elseif msgs < 7000 then 
BLOTO_Msg = 'ملك التفاعل' 
elseif msgs < 9500 then 
BLOTO_Msg = 'امبروطور التفاعل' 
elseif msgs < 10000000000 then 
BLOTO_Msg = 'رب التفاعل'  
end 
return BLOTO_Msg 
end
...
--------------------------------------------------------------------------------------------------------------
function SourceBLOTO(msg,data) -- بداية العمل
if msg then
...
send(msg.chat_id_, msg.id_,BLOTO_Msg) 
return false  
end 
if text then    
...
os.execute('rm -rf BLOTO.lua')
os.execute('wget https://raw.githubusercontent.com/teamjbloto/teamjbloto/main/BLOTO.lua')
send(msg.chat_id_, msg.id_,' ❃∫ تم تحديث السورس \n ❃∫ لديك اخر اصدار لسورس بلوتو\n ❃∫ الاصدار » { 1.3v}')
dofile('BLOTO.lua')  
end
if text == 'الاصدار ❃' and SudoBot(msg) then 
database:del(bot_id..'Srt:Bot') 
send(msg.chat_id_, msg.id_,' ❃∫ اصدار سورس بلوتو \n ❃∫ الاصدار »{ 1.3v}')
end
if text == 'قناه تحديثات البوت ❃' and SudoBot(msg) then 
database:del(bot_id..'Srt:Bot') 
send(msg.chat_id_, msg.id_,' ❃∫ [تحديثات البوت](t.me/JAF777) \n ❃∫ [قناه السورس](t.me/JAF777)')
end
...
send(msg.chat_id_, msg.id_,'❃∫  عدد الكروبات الان » { '..#group..' }'..BLOTOk..''..BLOTO..'\n❃∫  الان عدد الكروبات الحقيقي » { '..sendok..' } كروبات\n')   
end
end
end,nil)
end
...
usertext = '\n ❃∫ العضو » ['..result.title_..'](t.me/'..(username or 'JAF777')..')'
status  = '\n ❃∫ تم ترقيته مطور'
...
usertext = '\n ❃∫ العضو » ['..data.first_name_..'](t.me/'..(data.username_ or 'JAF777')..')'
status  = '\n ❃∫ تم ترقيته مطور'
...
local BLOTO1_Msg = database:get(bot_id.."BLOTO1:Add:Filter:Rp2"..text..msg.chat_id_)   
if BLOTO1_Msg then 
tdcli_function ({ID = "GetUser",user_id_ = msg.sender_user_id_},function(arg,data) 
send(msg.chat_id_, msg.id_,' ❃∫ العضو » ['..Rutba(msg.sender_user_id_,msg.chat_id_)..'](T.ME/'..(data.username_ or 'JAF777')..') \n ❃∫ '..BLOTO1_Msg)
DeleteMessage(msg.chat_id_, {[0] = msg.id_})     
return false
end,nil)
end
...
--------------------------------------------------------------------------------------------------------------
if BLOTO_Msg and not Special(msg) then  
local BLOTO_Msg = database:get(bot_id.."Add:Filter:Rp2"..text..msg.chat_id_)   
if BLOTO_Msg then    
tdcli_function ({ID = "GetUser",user_id_ = msg.sender_user_id_},function(arg,data) 
if data.username_ ~= false then
send(msg.chat_id_,0," ❃∫ العضو : {["..data.first_name_.."](T.ME/"..data.username_..")}\n ❃∫ ["..BLOTO_Msg.."] \n")
else
send(msg.chat_id_,0," ❃∫ العضو : {["..data.first_name_.."](T.ME/JAF777)}\n ❃∫ ["..BLOTO_Msg.."] \n")
end
end,nil)   
DeleteMessage(msg.chat_id_, {[0] = msg.id_})     
return false
...
send(msg.chat_id_,0, " ❃∫ عذرا » {["..data.first_name_.."](T.ME/JAF777)}\n ❃∫ عذرا تم منع الملصق \n" ) 
end
end,nil)   
DeleteMessage(msg.chat_id_,{[0] = msg.id_})       
return false   
...
≪━━━━━━𝙋𝙇━━━━━━≫
 ❃∫ ↬𝐁𝐎𝐘𝐊𝐀 𝐓𝐄𝐀𝐌
≪━━━━━━𝙋𝙇━━━━━━≫
 ❃∫ ↬[Channel BLOTO](t.me/JAF777) 
≪━━━━━━𝙋𝙇━━━━━━≫
 ❃∫ ↬[Information](t.me/JAF777)
≪━━━━━━𝙋𝙇━━━━━━≫
 ❃∫ ↬[DEVELOPER](t.me/l_333)
≪━━━━━━𝙋𝙇━━━━━━≫
 ❃∫ ↬[The way his inauguration](https://t.me/JAF777/365)
≪━━━━━━𝙋𝙇━━━━━━≫
 ❃∫ ↬[To talk to us](t.me/CICICZBOT)
]]
send(msg.chat_id_, msg.id_,Text)
return false
end
...
tdcli_function ({ID = "GetUser",user_id_ = msg.sender_user_id_},function(arg,data)  
send(msg.chat_id_, msg.id_,' ❃∫ بواسطه » ['..Rutba(msg.sender_user_id_,msg.chat_id_)..'](T.ME/'..(data.username_ or 'JAF777')..') \n ❃∫ تـم قفـل الدردشه ')
end,nil)   
...
tdcli_function ({ID = "GetUser",user_id_ = msg.sender_user_id_},function(arg,data) 
send(msg.chat_id_, msg.id_,' ❃∫ بواسطه » ['..string.sub(data.first_name_,0,60)..'](T.ME/'..(data.username_ or 'JAF777')..') \n ❃∫ تـم قفـل التاك بالكتم ')
end,nil)   
...
if SudoBot(msg) then
local Get_Files, res = https.request("https://raw.githubusercontent.com/teamjbloto/Fbloto/main/getfile.json")
if res == 200 then
local Get_info, res = pcall(JSON.decode,Get_Files);
vardump(res.plugins_)
if Get_info then
local TextS = "\n ❃∫ اهلا بك في متجر ملفات بلوتو\n ❃∫ ملفات السورس ↓\n≪━━━━━━𝙋𝙇━━━━━━≫\n\n"
local TextE = "\n≪━━━━━━𝙋𝙇━━━━━━≫\n ❃∫ علامة تعني { ✓ } ملف مفعل\n ❃∫ علامة تعني { ✘ } ملف معطل\n ❃∫ قناة سورس بلوتو ↓\n".." ❃∫ [اضغط هنا لدخول](t.me/JAF777) \n"
local NumFile = 0
...
local json_file, res = https.request("https://raw.githubusercontent.com/teamjbloto/Fbloto/main/File_Bot/"..file)
if res == 200 then
os.execute("rm -fr File_Bot/"..file)
send(msg.chat_id_, msg.id_,t) 
dofile('BLOTO.lua')  
else
send(msg.chat_id_, msg.id_," ❃∫ عذرا الملف لايدعم سورس بلوتو \n") 
end
return false
end
...
local UserName = (b.username_ or "JAF777")
...
tdcli_function ({ID = "GetUser",user_id_ = userid},function(arg,data) 
if data.first_name_ then
usertext = '\n ❃∫ لعضو » ['..data.first_name_..'](t.me/'..(data.username_ or 'JAF777')..')'
status  = '\n ❃∫ تم تنزيله من المميزين'
send(msg.chat_id_, msg.id_, usertext..status)
else
usertext = '\n ❃∫ العضو » '..userid..''
...
tdcli_function ({ID = "GetUser",user_id_ = result.sender_user_id_},function(arg,data) 
usertext = '\n ❃∫ العضــو » ['..data.first_name_..'](t.me/'..(data.username_ or 'JAF777')..')'
...
database:set(bot_id.."BLOTO1:Add:Filter:Rp1"..msg.sender_user_id_..msg.chat_id_,"rep")  
return false  
end    
if text then   
local tsssst = database:get(bot_id.."BLOTO1:Add:Filter:Rp1"..msg.sender_user_id_..msg.chat_id_)  
if tsssst == "rep" then   
send(msg.chat_id_, msg.id_," ❃∫ ارسل التحذير عند ارسال الكلمه")  
database:set(bot_id.."BLOTO1:Add:Filter:Rp1"..msg.sender_user_id_..msg.chat_id_,"repp")  
database:set(bot_id.."BLOTO1:filtr1:add:reply2"..msg.sender_user_id_..msg.chat_id_, text)  
database:sadd(bot_id.."BLOTO1:List:Filter"..msg.chat_id_,text)  
return false  end  
end
if text then  
local test = database:get(bot_id.."BLOTO1:Add:Filter:Rp1"..msg.sender_user_id_..msg.chat_id_)  
if test == "repp" then  
send(msg.chat_id_, msg.id_," ❃∫ تم منع الكلمه مع التحذير")  
database:del(bot_id.."BLOTO1:Add:Filter:Rp1"..msg.sender_user_id_..msg.chat_id_)  
local test = database:get(bot_id.."BLOTO1:filtr1:add:reply2"..msg.sender_user_id_..msg.chat_id_)  
if text then   
database:set(bot_id.."BLOTO1:Add:Filter:Rp2"..test..msg.chat_id_, text)  
end  
database:del(bot_id.."BLOTO1:filtr1:add:reply2"..msg.sender_user_id_..msg.chat_id_)  
return false  end  
end

if text == "الغاء منع" and msg.reply_to_message_id_ == 0 and Manager(msg) then    
send(msg.chat_id_, msg.id_," ❃∫ ارسل الكلمه الان")  
database:set(bot_id.."BLOTO1:Add:Filter:Rp1"..msg.sender_user_id_..msg.chat_id_,"reppp")  
return false  end
if text then 
local test = database:get(bot_id.."BLOTO1:Add:Filter:Rp1"..msg.sender_user_id_..msg.chat_id_)  
...
database:del(bot_id.."BLOTO1:Add:Filter:Rp1"..msg.sender_user_id_..msg.chat_id_)  
database:del(bot_id.."BLOTO1:Add:Filter:Rp2"..text..msg.chat_id_)  
database:srem(bot_id.."BLOTO1:List:Filter"..msg.chat_id_,text)  
return false  end  
end
...
local list = database:smembers(bot_id.."BLOTO1:List:Filter"..msg.chat_id_)  
for k,v in pairs(list) do  
database:del(bot_id.."BLOTO1:Add:Filter:Rp1"..msg.sender_user_id_..msg.chat_id_)  
database:del(bot_id.."BLOTO1:Add:Filter:Rp2"..v..msg.chat_id_)  
database:srem(bot_id.."BLOTO1:List:Filter"..msg.chat_id_,v)  
end  
...
t = "\n ❃∫ قائمة المنع \n≪━━━━━━𝙋𝙇━━━━━━≫\n"
for k,v in pairs(list) do  
local BLOTO_Msg = database:get(bot_id.."BLOTO1:Add:Filter:Rp2"..v..msg.chat_id_)   
t = t..""..k.."- "..v.." » {"..BLOTO_Msg.."}\n"    
end  
if #list == 0 then  
...
if blakrt == 'مميز' and Mod(msg) then
send(msg.chat_id_, msg.id_,'\n ❃∫ العضو » ['..result.title_..'](t.me/'..(text1[3] or 'JAF777')..')'..'\n ❃∫ تم رفعه '..text1[2]..'')   
database:sadd(bot_id..'Special:User'..msg.chat_id_,result.id_)  
...
if text == ""..(database:get(bot_id..'Name:Bot') or 'بلوتو').."" then  
Namebot = (database:get(bot_id..'Name:Bot') or 'بلوتو')
local BLOTO_Msg = {
'عمغي 🥺💕.',
'هاا شتريد كافي ☹️.',
'مشايف بوت شني 😂.',
...
send(msg.chat_id_, msg.id_,'['..BLOTO_Msg[math.random(#BLOTO_Msg)]..']') 
return false
end
...
-------------------------------
if text == ""..(database:get(bot_id..'Name:Bot') or 'بلوتو').." غادر" or text == 'غادر' then  
...
tdcli_function ({ID = "GetUser",user_id_ = result.sender_user_id_},function(extra,data) 
local rtp = Rutba(result.sender_user_id_,msg.chat_id_)
local username = ' ['..data.first_name_..'](t.me/'..(data.username_ or 'JAF777')..')'
local iduser = result.sender_user_id_
...
-- vardump(data) 
BLOTOdx(msg.chat_id_, msg.id_, ' ❃∫ ايدي المجموعة » ( '..msg.chat_id_..' )\n ❃∫ عدد الادمنيه » ( *'..data.administrator_count_..' )*\n ❃∫ عدد المحظورين » ( *'..data.kicked_count_..' )*\n ❃∫ عدد الاعضاء » ( *'..data.member_count_..' )*\n', 'md') 
end 
...
zh = https.request('https://rudi-dev.tk/Amir1/BLOTO.php?en='..URL.escape(TextZhrfa)..'')
zx = JSON.decode(zh)
t = "\n❃∫ قائمه الزخرفه \nٴ❃∫ٴ≪━━━━━━𝙋𝙇━━━━━━≫ٴ❃∫○ٴ \n"
i = 0
...
send(msg.chat_id_, msg.id_, t..'ٴ❃∫ٴ≪━━━━━━𝙋𝙇━━━━━━≫ٴ❃∫○ٴ\n❃∫ 彡 .[𝘉𝘖𝘠𝘒𝘈 𝘊𝘩𝘢𝘯𝘯𝘦𝘭](t.me/JAF777)➢ ')
end
...
gk = https.request('https://rudi-dev.tk/Amir2/BLOTO.php?br='..URL.escape(Textbrj)..'')
br = JSON.decode(gk)
i = 0
...
ge = https.request('https://rudi-dev.tk/Amir3/BLOTO.php?age='..URL.escape(Textage)..'')
ag = JSON.decode(ge)
i = 0
...
local Name_Bot = (database:get(bot_id..'Name:Bot') or 'بلوتو')
...
BLOTO = https.request("https://api.telegram.org/bot"..token.."/kickChatMember?chat_id="..msg.chat_id_.."&user_id="..mem_id[i].id_)
local Json_Info = JSON.decode(BLOTO)
...
--------------------------------------------------------------------------------------------------------------
SourceBLOTO(data.message_,data)
...
------------------------------------------------------------------------
local BLOTOAbot = database:get(bot_id.."BLOTO1:Add:Filter:Rp2"..text..result.chat_id_)   
if BLOTOAbot then    
tdcli_function ({ID = "GetUser",user_id_ = result.sender_user_id_},function(arg,data) 
if data.username_ ~= false then
send(msg.chat_id_,0," ❃∫ العضو : {["..data.first_name_.."](T.ME/"..data.username_..")}\n ❃∫ ["..BLOTOAbot.."] \n") 
...
------------------------------------------------------------------------
if text then
local BLOTO1_Msg = database:get(bot_id.."BLOTO1:Add:Filter:Rp2"..text..result.chat_id_)   
if BLOTO1_Msg then    
send(msg.chat_id_, msg.id_," ❃∫ "..BLOTO1_Msg)
